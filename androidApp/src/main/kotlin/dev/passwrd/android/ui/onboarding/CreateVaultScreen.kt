package dev.passwrd.android.ui.onboarding
 ...
 * NO zxcvbn): es una guía visual para el usuario, no una decisión de seguridad — la
 * resistencia real la da Argon2id (ver docs/CRYPTO_SPEC.md), no esta heurística.
 */
